...
def define_registration_model(gpu_ids=None, is_training=True, model_parallel=False, mode='lpba40', img_size=(128, 128, 128)):
    if model_parallel:
...
class contrastive_loss(nn.Module):
    def __init__(self, batch_size=4, temperature=0.1, use_cosine_similarity=True):
