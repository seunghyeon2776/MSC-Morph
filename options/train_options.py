...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter_decay', type=int, default=199, help='# of iter to linearly decay learning rate to zero')
        ...
        self.parser.add_argument('--num_classes', type=int, default=35, help='lpba40')
